...
#%% Write to read_data file for Kremer-Grest melt with freely rotating dipoles, angles and spheres
            
def write2lammpsin_neat_angle_sphere(N, M, L, name, mass, dens, diam, r, mu):
    ...
    for i in range(1, M*N+1):
        ...
        in_file.write('{:d} {:d} {:f} {:f} {:f} {:f} {:f} {:d} {:.3f} {:.3f} {:.3f} {:d}\n'.format(i, 1, r[i-1,0], r[i-1,1], r[i-1,2], diam, dens, 0, mu[i-1,0], mu[i-1,1], mu[i-1,2], np.int(np.floor((i-1)/N)+1)))
