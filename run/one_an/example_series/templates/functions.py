...
def write2lammpsin_onecat_angle_sphere(N, M, L, name, masses, dens, diam, r, rc, mu):
    ...
    in_file.write('{:d} {:d} {:f} {:f} {:f} {:f} {:f} {:.1f} {:d} {:d} {:d} {:d}\n'.format(atom_ID, 2, rc[0], rc[1], rc[2], diam[1], dens[1], 1.0, 0, 0, 0, molecule_ID))
...
def write2lammpsin_onean_angle_sphere(N, M, L, name, masses, dens, diam, r, ra, mu):
    ...
    in_file.write('{:d} {:d} {:f} {:f} {:f} {:f} {:f} {:.1f} {:d} {:d} {:d} {:d}\n'.format(atom_ID, 2, ra[0], ra[1], ra[2], diam[1], dens[1], -1.0, 0, 0, 0, molecule_ID))
