...
#SBATCH --job-name=mu_0.416	 # The job name.
...
mpirun -np 12 --oversubscribe /rigel/home/mct2180/lammps-3Mar20/src/lmp_mpi -in in_LOG_RUN.ELEC 
python main_POST_LOG.py
# End of script
